...
Required Notice: Motion-TimeSpace-sim is source-available for personal and non-commercial use. Commercial use, including incorporation into paid products, hosted services, managed services, enterprise products, or commercial AI coding/agent products, requires a separate written license from the licensor.
